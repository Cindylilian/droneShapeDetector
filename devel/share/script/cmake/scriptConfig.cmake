...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'script' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cindy/tum_simulator_ws/src/script/${idir}'.  Ask the maintainer 'cindy <cindy@todo.todo>' to fix it.")
    endif()
